public class Main {
    ...
    public static void main(String[] args) {
        ...
        Student student2 = new Student("Minh Zu","Pham",34629,"s34628@pjwstk.edu.pl","xyz",new double[] {2, 3.5, 5, 2, 2, 1, 2});

        Student student3 = new Student("Minh Ga","Pham",34630,"s34628@pjwstk.edu.pl","xyz",new double[] {2, 3.5, 5, 2, 2, 1, 2});
